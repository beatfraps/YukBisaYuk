            ...
            <div class="col-md-20 w-35">
                <div class="shadow p-5 bg-white round">
                    <form method="POST" action="{{ route('postRegister') }}">
						...
						<input type="text" id="authFormFName" name="firstname" class="form-control mb-2 " placeholder="Nama Depan" autofocus required>
                        <input type="text" id="authFormLName" name="lastname" class="form-control mb-2 " placeholder="Nama Belakang" autofocus>
